...
import { Option, QuestionTypeEnum } from '../../types/question.request.types'
...
interface OptionsProps {
  ...
  onChange: (value: string, questionIndexValue: number, optionIndexValue: number) => void
  removeOption: (questIndex: number, optionIndex: number) => void
}
export const Options = (props: OptionsProps) => {
  const { options, questionType, questionIndex, onChange, removeOption, addOption } = props
  return (
  <>
      ...
      <OptionInput
       ...
       <span>o</span>
        <Button
          ...
          variant='text'
          color='primary'
          style={{ textTransform: 'none', width: 'auto', paddingBottom: 0 }}
